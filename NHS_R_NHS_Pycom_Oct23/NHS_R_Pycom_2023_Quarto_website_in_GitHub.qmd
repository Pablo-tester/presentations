...
::: columns
::: {.column width="40%"}
![](NHSR_Pycon_images/03_Step_02_new%20github_repo_%20website.png)
:::

::: {.column width="60%"}
![](NHSR_Pycon_images/04_Step_02_New_%20repo_%20website_name.png)
...
::: columns
::: {.column width="40%"}
![](NHSR_Pycon_images/06_Step_03_create_%20folder_01.png)
...
::: {.column width="60%"}
![](NHSR_Pycon_images/07_Step_03_create%20project_01.png) ![](NHSR_Pycon_images/08_Step_03_create%20project_02.png)
:::
:::
...
::: columns
::: {.column width="40%"}
![](NHSR_Pycon_images/09_Step_05_Create_quarto_website%2001.png)
:::
...
::: columns
::: {.column width="40%"}
![](NHSR_Pycon_images/11_Step_05_cuarto_website_files_01.png) It that will be populated with the following Quarto related files: - quarto.yml
...
::: {.column width="60%"}
![](NHSR_Pycon_images/12_Step_05_cuarto_website_files_02.png) ![](NHSR_Pycon_images/13_Step_05_cuarto_website_files_03.png)
:::
:::
